...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $.post('API_ecommerce.php', {
            ...
            // #nom du champs input - info_user[0].nom_champs_bdd
            $('#email').val(info_user[0].email);
            $('#nom').val(info_user[0].username);
            $('#prenom').val(info_user[0].username);
            $('#password').val(info_user[0].password);
        })
        ...
        $('.form-control').on('click', function () {
            ...
            if (id == "password"){
                var newValue = prompt("Ecriver votre nouveau password", "");
