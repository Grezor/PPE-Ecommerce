...
for ($i = 0; $i < 50; $i++) {
    ...
    $code_article = $faker->numberBetween(9, 500000);
    ...
    // Requete Insert
    $requeteInsert = $bdd->prepare('INSERT INTO produits (nom, description, prix, img_url, promo, stock, code_article) 
                                              values (:nom, :description, :prix, :img_url, :promo, :stock, :code_article)');
    // execute requete
